...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("ExoFuel", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("ExoFuel", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "115";
		app.meta["company"] = "HoneyBadgers";
		app.meta["file"] = "ExoFuel";
		app.meta["name"] = "ExoFuel";
